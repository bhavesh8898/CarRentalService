...
class rent : public customer // inhereted class from customer class
{
    ...
    do
    {
        ...
        cout<<"\t\t\t\tEnter 'A' for Mercedes S-class."<<endl;
        cout<<"\t\t\t\tEnter 'B' for BMW 720d."<<endl;
        cout<<"\t\t\t\tEnter 'C' for Audi A7."<<endl;
        cout<<endl;
 ...
 if(carmodel=="A")
 {
 	system("CLS");
		...
		cout<<"You have choosed Mercedes S-class"<<endl;
...
sleep(2);
  ...
  if(carmodel=="B")
  {
  	system("CLS");
		...
		cout<<"You have choosed BMW 720d"<<endl;
 ...
 {
 	system("CLS");
	     cout<<"You have choosed Audi A7"<<endl;
